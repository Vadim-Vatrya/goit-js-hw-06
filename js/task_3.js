...
// const getUsersWithGender = (array, gender) => array.filter(array => array.gender === gender).map(elem => elem.name);

const getUsersWithGender = (array, gender) => array.filter(human => human.gender === gender).map(elem => elem.name);
//     .map(({name}) => name);

const getUsersWithGender = users.filter(human => human.gender === gender)
    .map(elem => elem.name);
